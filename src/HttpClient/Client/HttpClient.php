...
namespace Framework\HttpClient\Client;

use Framework\HttpClient\Factory\RequestFactory;
use Framework\HttpClient\Factory\ResponseFactory;
use Framework\HttpClient\Factory\StreamFactory;
